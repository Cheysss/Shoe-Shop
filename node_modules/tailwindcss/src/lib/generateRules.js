...
function generateRules(candidates, context, isSorting = false) {
  ...
  for (let candidate of candidates) {
    ...
    for (const match of matches) {
      ...
      let newEntry = [sort, isSorting 6 ‹ÏèÉüÿL$èúÿëœ‹D$L$‰t$‹t$Q‹8VP‹OXÿÈUÿWX‹ø…ÿyQWh¨`º'  ë*‹D$SP‹‹¹H  ‹ÏÿÈUÿ×‹ø…ÿy"QWhp`º)  hH`¹˜Yèš5 ‹Ïè„ÈüÿL$èúÿL$èøúÿVÿÄ€‹ÏèµÇüÿ‹L$4‹Ç_^[3Ìèf ‹å]Ã‹ÿU‹ììŒ   ¡.3Å‰EüSVW3À½xÿÿÿ«µxÿÿÿ‹ÙM«««‹û¥¥¥¥3ö‰u”è÷ÿÿ‹ø…ÿy*QWhğZº:  h a¹˜Yè